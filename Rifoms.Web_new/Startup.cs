...
using Rifoms.Web_new.Infrastructure.Access;
using Rifoms.Web_new.Infrastructure.Cookies;

using System;
using System.IO;

namespace Rifoms.Web_new
{
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
                ...
                routes.MapRoute(
                  ...
                  defaults: new { controller = "Auth", action = "Test" });
                ...
                routes.MapRoute(
                   name: "rss",
                   template: "rss/content/{id}/feed.rss",
